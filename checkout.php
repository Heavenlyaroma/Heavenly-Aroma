...
<?php
    ...
    if(isset($_POST['update_cart'])) {
            ...
            mysqli_query($con, "UPDATE  'products' SET Quantity = '$update_quantity'WHERE id='$update_id'" ) or die('query failed') ;
...
<body class="wishlistbacgroud">
    ...
    <h2 class="prouctTitle">YOUR TRUST IS  MORE THAN OUR CHARIEST VALUE</h2>
    ...
    <a href="shop.php"><button class="checkout">Back to shop</button></a>
        ...
        <table class="content-table3">
            ...
            <tbody class="cart-item-allshop">
                ...
                <tr class="cart-item-all">
                    ...
                    <td>
                        <form action="" method="post" class="input-quantity">
    ...
    <section>
        ...
        <div class="delivery_details">
            ...
            <h2 class="titlebascket">Delivery details</h2>
            <div class="shipping_checkout">
                <div>
                ...
                <div class="zip_code">
                    <label class="zipcode"><em>*</em>Zip cod / Postal code</label>
                    <input type="text"  title="zipcode"name="zipcod" required placehoder="zipcode" class="box1">
                </div>
                <div class="address">
                    <label for="billing:street1" class="required"><em>*</em>Address</label> 
                ...
                <label class=incoterm> Delivery methode</label>
           
                <div class="delivery_method">
                    
                    <div class="incoterms1">
                        <p>Airway Inconterm </p>
                        <form action="" method="post">
                        
                            <select class="form-select" id="incoterm1" name="incoterms1">
                                <option value="Airway transport"></option>
                                <option value="1">EXW</option>
                                <option value="2">FCA</option>
                                <option value="3">CIP</option>
                                <option value="4">DAP</option>
                                <option value="5">PDU</option>
                                <option value="6">DDP</option>
                            </select>

                        </form>
                    </div>
                    <div class="incoterms2">
                        <p>Sea and Waterway Inconterms   </p>
                        <form action="" method="post">
                    
                            <select class="form-select" id="incoterm2" name="incoterms2">
                                <option value="Seaway transport"></option>
    ...
    <div class="order">
            ...
            <a href="shop.php"><button class="order">Confirm and place order</button></a>
        </div>
